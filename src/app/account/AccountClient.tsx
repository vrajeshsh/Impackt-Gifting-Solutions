...
import { Heart, User, Settings, LogIn, LogOut, Moon, Sun, Package, Edit3, Save, X, Loader2 } from 'lucide-react';
...
function AccountClient() {
  ...
  const { user, profile, isLoading, signOut, updateProfile, error: authError, clearError } = useAuth();
                    ...
                    <div className="space-y-6">
                      ...
                      {isEditing ? (
                        <div className="space-y-4 max-w-md">
                          ...
                          {saveMessage && (
                            <p className={`text-xs ${saveMessage.includes('successfully') ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                              {saveMessage}
                            </p>
                          )}
...
function AccountSearchParamsClient() {
  useSearchParams();
  return null;
}
